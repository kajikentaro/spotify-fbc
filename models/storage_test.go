...
func TestSearchQueryWithoutIsrc(t *testing.T) {
	v := TrackContent{
		Id:       "123",
		Name:     "test track",
		Artist:   "test artist",
	...
	expected := "test+track%2520test+artist%2520test+album"
	if expected != actual {
		t.Errorf("\nactual:\n%s \nexpected:\n%s", actual, expected)
	}
}

func TestSearchQueryWithIsrc(t *testing.T) {
	v := TrackContent{
		Id:       "123",
		Name:     "test track",
		Artist:   "test artist",
